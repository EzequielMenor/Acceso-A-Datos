...
public class TextTable {
     ...
     * El nombre debe de coincidir con el indicado en el momento de la
     * creación/reset de la TextTable
     * 
     * @param header Nombre de la columna sobre la que se quiere establecer la
     *               alineación
     ...
     * Si la cantidad de valores indicados no se corresponde con la cantidad de
    ...
    /**
     * Obtiene la representación en texto de la tabla tabulada con los anchos de
     * columna ajustados
     * 
